function NutrientsTimeSeries() {
  ...
  this.name = 'Household Nutrient Intakes: 1974-2019';
  ...
  this.title = 'Household Nutrient Intakes: 1974-2019';
  ...
  this.preload = function() {
      var self = this;
      this.data = loadTable(
      './data/food/nutrients74-19.csv', 'csv', 'header',
      ...
      for(var j = 0; j < legend.length; j++)
      {
          ...
          for (var i = 0; i < this.series[legend[j]].length; i++) 
          {
              ...
              if (previous != null) {
                  ...
                  noStroke();
                  fill(this.colors[j])
                  text(legend[j], 80 ,this.mapYToHeight(current.percentage) -20)  
                  pop();
              }
