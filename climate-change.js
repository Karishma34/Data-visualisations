      ...
      if (previous != null
        ...
        noStroke();
         fill(this.mapTemperatureToColour(current.temperature));
          ...
          //add in the padding which is the leftMargin
          //segmentWidth is the bar thickness between one to another
          
          //rect(this.layout.leftMargin + (i-1)* segmentWidth,this.layout.topMargin,segmentWidth,this.layout.bottomMargin-this.layout.topMargin);
          //replace the value i with a new value when the start and end year changes
