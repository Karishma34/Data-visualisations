    ...
    for (var i = 0; i < this.data.getRowCount(); i++) {
      ...
      var current = {
        // Convert strings to numbers.
         ...
         //console.log(current.year + " " + current.payGap);

      if (previous != null) {
        // Draw line segment connecting previous year to current
        // year pay gap.
        stroke(0);
        //line(this.startYear, this.minPayGap, this.endYear, this.maxPayGap );
  ...
  this.mapPayGapToHeight = function(value) {
    //
      return map(value,
               this.minPayGap,
               this.maxPayGap,
               this.layout.bottomMargin,   // Draw bottom-to-topline from margin.
